...
public class HashFunctions {
	...
	public static void main(String[] args) {
		...
		HashFunctions hashFunc = new HashFunctions(31);
...
//				"400", "415", "450", "50", "660", "624" };
		...
		hashFunc.hashFunction2(elementsToAdd2, hashFunc.theArray);

		// hashFunc.modThirty();

		hashFunc.increaseArraySize(60);

		hashFunc.displayTheStack();

		hashFunc.fillArrayWithNeg1();

		hashFunc.doubleHashFunc(elementsToAdd2, hashFunc.theArray);

		hashFunc.displayTheStack();

		hashFunc.findKeyDblHashed("90");
